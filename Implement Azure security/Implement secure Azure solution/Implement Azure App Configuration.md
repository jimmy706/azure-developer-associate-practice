# Explore Azure App Configuration Services
...
> Configurations that are stored in Azure App Configuration as key-value pairs.
...
Example of keys using hierarchy approach:
